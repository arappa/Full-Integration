...
public class StrBuilder {
	public void doStrB() {
		...
		// Has three integers and uses sb append to put together IP addresses with the
		// help of a for loop.
		int ip1 = 192;
		int ip2 = 168;
		int ip3 = 1;
		String dot = ".";
		// For loop to put the IP address together. Int i = 1 to start at first part of
		...
		for (int i = 1; i <= 1; i++) {
			...
			// Set the length of the sb object to zero(0) so that you can clear the string.
			strB.setLength(0);
			...
			// Replaces all ones(1) in the string with the letter c. (regex, replacement)
