...
//This project is a collection of all the different skills I have learned over the semester put into one program.
...
public class Main {
	...
	public static void main(String[] args) {
		// Welcome message
		System.out
				.println("Hello Professor Vanselow, this here is my integration project. This project will show all the"
						+ " skills that I have learned over the semester through a series of examples. Enjoy!");
		...
		p1.setGender("Male");
		p1.setAge(25);
		System.out.println("NAME: " + p1.getName() + " GENDER: " + p1.getGender() + " AGE: " + p1.getAge());
		...
		do {
			try {
				int person1 = Integer.parseInt(JOptionPane.showInputDialog("Enter the first persons age."));
				int person2 = Integer.parseInt(JOptionPane.showInputDialog("Enter the second persons age."));
				// Method invoked
		...
		/*
		 * Polymorphism example You can assign different objects to variables as long as
		 * its reference variable is of the superclass type.
		 */
