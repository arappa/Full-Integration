...
public class StringManip {
	public static void stringUsage() {
		...
		System.out.println("My steam account is https://steamcommunity.com/id/" + steamUserName);
		...
		if (boolCheck == true) {
			System.out.println("The string " + gamerTag + " contains the char sequence " + check + ".");
		} else {
			System.out.println("The string " + gamerTag + "does not contain the char sequence " + check + ".");
		}
