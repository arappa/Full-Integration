...
public class NumericAndStringData {
	public static void dataExamples() {
		...
		System.out.println("This" + " is an example" + " of concatenation" + " of string data" + " with the use of the"
				+ " + operator.");
		...
		System.out.println("The remainder between the two numbers is: " + remainder);
