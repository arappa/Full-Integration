...
//This code takes in the int data type from two users and compares them to 
//output the age difference between the users.
public class AgeDifference {
  ...
  public void subtract(int person1, int person2) {
    ...
    if (person1 > person2) {
      ...
      System.out
          .println("You are both the same age. There is no age difference.");
